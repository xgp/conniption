...
public class TradeKing {
  ...
  public Quotes quotes(String... symbols) {
    return get(MarketBuilder.getQuotes(ResponseFormat.XML, symbols), null, "com.celexus.conniption.model.quotes",
        Quotes.class);
  }
  ...
  public OrderResponse preview(String accountId, String fixml) {
    return get(OrdersBuilder.preview(accountId, fixml, ResponseFormat.XML), null, "com.celexus.conniption.model.order",
        OrderResponse.class);
  }

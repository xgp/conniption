...
public class MarketBuilder extends APIBuilder {
    ...
    public static MarketBuilder getQuotes(
            ResponseFormat format, String[] symbols, MarketQuotesResponseField[] fields) {
        ...
        if (!fids.toString().isEmpty()) {
            b.params.put(
                    MarketQuotesField.FIDS.toString(), fids.toString().trim().replace(" ", ","));
        }
        return b;
    }
    ...
    public enum MarketQuotesResponseField implements Serializable {
         ...
         * Dividend, Q - Quarterly Dividend, M - Monthly Dividend, N - Not
         * applicable or No Set Dividend Frequency.
         */
        ...
        /**
         * imp_volatility Option, Implied volatility of option price based current
         * stock price
         */
        ...
        /**
         * op_delivery Option, Option Settlement Designation – S Std N – Non Std X -
         * NA
         */
        ...
        /**
         * tradetick Stock, Option Tick direction from prior trade – (e,u,d) even,
         * up, down)
         */

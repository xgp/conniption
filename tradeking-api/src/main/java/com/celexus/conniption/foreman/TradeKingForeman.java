...
public class TradeKingForeman implements Serializable {
    ...
    private void connect() throws ForemanException {
        ...
        srv =
                new ServiceBuilder()
                        ...
                        .apiSecret(ForemanConstants.API_SECRET.toString())
    ...
    public TKResponse makeAPICall(APIBuilder b) throws ForemanException {
        ...
        return sendRequest(
                makeRequest(b.getVerb(), b.getResourceURL(), b.getParameters(), b.getBody()));
    }
    ...
    private OAuthRequest makeRequest(
            Verb verb, String resourceURL, Map<String, String> parameters, String payload) {

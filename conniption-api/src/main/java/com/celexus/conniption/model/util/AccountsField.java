...
public enum AccountsField implements Serializable {
    /**
     * accounttype Holdings attribute for where asset as held, "1"= cash, "2"=
     * margin long, "5"=margin short.
     */
    ...
    /**
     * cashavailableforwithdrawal Cash available for withdrawal (cash & margin
     * accounts only, n/a for retirement accounts)
     */
    ...
    /**
     * marginbalance Margin balance (- indicates debit balance, + indicates
     * credit balance)
     */
    ...
    /**
     * options Total option market value. Path:
     * /response/accounts/accountsummary/accountbalance/securities/
     */
    TOTAL_OPTIONS_MARKET_VALUE("options", "//accountbalance/securities/"),
    /**
     * options Options buying power. Path:
     * /response/accounts/accountsummary/accountbalance/buyingpower/
     */
    ...
    /**
     * total Total cash balance. Path:
     * /response/accounts/accountsummary/accountbalance/money/
     */
    TOTAL_CASH_BALANCE("total", "//accountbalance/money/"),
    /**
     * total Total market value (stock & option). Path:
     * /response/accounts/accountsummary/accountbalance/securities/
     */
